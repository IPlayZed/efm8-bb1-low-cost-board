//=========================================================
// src/adc5_main.c: generated by Hardware Configurator
//
...
// Global variables
extern volatile uint32_t adc0_data;
...
float ADC0InVolts (uint32_t adc0_data) {
...
int main (void)
{
  ...
  while (1) 
  {
    ...
    // [Generated Run-time code]$
      ...
      average = adc0_data/1000;

      Volts = ADC0InVolts(average);
